...
def test1():
    ...
    assert result == squ.RamProduct(brand='G.Skill', ram_type='DDR4', speed=3200, total_gb=16, modules=1, gb_per_module=16, price=129.99, source='Newegg', raw_listing='G.SKILL Ripjaws V Series 16GB 288-Pin PC RAM DDR4 3200 (PC4 25600) Desktop Memory Model F4-3200C16S-16GVK')
